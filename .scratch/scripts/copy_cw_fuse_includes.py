...
VANILLA = Path(os.path.expandvars(r"%USERPROFILE%\Documents\Paradox Interactive\Hearts of Iron IV\mod\_sandbox"))
R56 = Path(os.path.expandvars(r"%USERPROFILE%\Documents\Paradox Interactive\Hearts of Iron IV\mod\_sandbox-r56"))
